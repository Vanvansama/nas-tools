...
class MetaTubeApi(object):
    ...
    def _call(self, action, params, method="GET"):
        host = ""
        url = host + action
        req = self._session.request(method, url, params, timeout=10, verify=False)
        json = req.json()
        return json
    ...
    def search(self, keyword):
        ...
        return self._get_obj(self._call(self._urls["search_movies"], params))
